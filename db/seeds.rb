...
if Item.count == 0
  item1 = Item.create(title: "Enforcer Bio Arm vQ49-e1", description: "Enforcer robotic prosthesis provides active actuation during gait to improve the biomechanics of gait, including, among other things, stability, symmetry, or energy expenditure for amputees.", price: 4690000, material: "Iridium", control_type: "Neuro-Linked Bionic", limb_id: 1, user_id: 1 )
  item1.picture.attach(
    io: File.open('../References/img/arm1.jpg'),
    filename: 'arm1.jpg',
    content_type: 'image/jpg'
  )
  item2 = Item.create(title: "Kusanagi emPOWER vRx-965", description: "Enhanced Kisanagi osseo-integrated bionic leg features actuators directly driving the joints, and semi-active legs, which use small amounts of energy and a small actuator to change the mechanical properties of the leg but do not inject net positive energy into gait.", price: 6150000, material: "Chromium", control_type: "Osseo-Integration", limb_id: 2, user_id: 1 )
  item2.picture.attach(
    io: File.open('../References/img/leg1.jpg'),
    filename: 'leg1.jpg',
    content_type: 'image/jpg'
  )
  item2 = Item.create(title: "Copperhead MyoElectric Leg X-21R", description: "MyoElectric Copperhead titanium leg uses microprocessor is used to interpret and analyze signals from knee-angle sensors and moment sensors. The microprocessor receives signals from its sensors to determine the type of motion being employed by the amputee.", price: 7640000, material: "Titanium", control_type: "Myoelectric", limb_id: 2, user_id: 2 )
  item2.picture.attach(
    io: File.open('../References/img/leg2.jpg'),
    filename: 'leg2.jpg',
    content_type: 'image/jpg'
  )
  item2 = Item.create(title: "Sokudo Bionic Eye vK-09X", description: "Full eyeball and retinal prosthesis featuring a subretinal stimulator, an array of electrodes, that is placed beneath the retina in the subretinal space and receives image signals.", price: 8450000, material: "Silicone Mesh", control_type: "Exo", limb_id: 5, user_id: 2 )
  item2.picture.attach(
    io: File.open('../References/img/eye.png'),
    filename: 'eye.png',
    content_type: 'image/png'
  )
  item2 = Item.create(title: "Sovereign xTremity Bio Hand Kr-48v", description: "14 different grip patterns and hand positions, the Sovereign makes it easier to perform any activity with ease. The force exerted by the prosthesis is directly controlled using a persons wrist, or the remaining portion of their hand, which makes movement and control feel very natural.", price: 4360000, material: "Titanium", control_type: "Neuro-Linked Bionic", limb_id: 3, user_id: 3 )
  item2.picture.attach(
    io: File.open('../References/img/hand2.jpg'),
    filename: 'hand2.jpg',
    content_type: 'image/jpg'
  )
  item2 = Item.create(title: "Katana Challenger xT-83", description: "Katana uses complementing levers connected through pivots to create mechanically-powered push off. Combining 27° of ankle motion and significantly greater ankle power than conventional carbon fiber feet, it closely mimics regular biomechanics.", price: 7990000, material: "Tritium", control_type: "Neuro-Linked Bionic", limb_id: 4, user_id: 3 )
  item2.picture.attach(
    io: File.open('../References/img/foot.png'),
    filename: 'foot.png',
    content_type: 'image/png'
  )
  puts "Items Created"
