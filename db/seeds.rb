...
if Item.count == 0
  ...
  item1.picture.attach(
    io: File.open('https://github.com/JLee-WD/prosma/blob/master/docs/img/arm1.jpg'),
    filename: 'arm1.jpg',
  ...
  item2.picture.attach(
    io: File.open('https://github.com/JLee-WD/prosma/blob/master/docs/img/leg1.jpg'),
    filename: 'leg1.jpg',
    content_type: 'image/jpg'
  )
  ...
  item2.picture.attach(
    io: File.open('https://github.com/JLee-WD/prosma/blob/master/docs/img/leg2.jpg'),
    filename: 'leg2.jpg',
    content_type: 'image/jpg'
  )
  ...
  item2.picture.attach(
    io: File.open('https://github.com/JLee-WD/prosma/blob/master/docs/img/eye.png'),
    filename: 'eye.png',
  ...
  item2.picture.attach(
    io: File.open('https://github.com/JLee-WD/prosma/blob/master/docs/img/hand2.jpg'),
    filename: 'hand2.jpg',
    content_type: 'image/jpg'  
  )
  ...
  item2.picture.attach(
    io: File.open('https://github.com/JLee-WD/prosma/blob/master/docs/img/foot.png'),
    filename: 'foot.png',
    content_type: 'image/png', 
  )
  puts "Items Created"
